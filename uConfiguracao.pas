...
begin
  ...
  begin
    ...
    if (ACertificado.ValidadeIni <> '') then
      Validade := 'de ' + ACertificado.ValidadeIni + ' ';
    Item.ItemByName['nxValidade' + Id].Value := Validade + 'até ' + ACertificado.ValidadeFim;
...
begin
  sbStatus.Panels[0].Text := 'v.06/01/2020-v.49';
end;                                           
